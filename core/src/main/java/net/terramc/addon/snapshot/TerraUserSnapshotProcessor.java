...
public class TerraUserSnapshotProcessor extends EntitySnapshotProcessor<Player> {

  public TerraUserSnapshotProcessor(EntitySnapshotRegistry registry) {
    super(registry);
  }
  ...
  public void process(Player player, float partialTicks, ExtrasWriter entityWriter) {
    this.registry().captureSnapshot(entityWriter, TerraAddonKeys.TERRA_USER, player);
  }
