...
public class TerraChatUserSnapshotProcessor extends EntitySnapshotProcessor<Player> {

  public TerraChatUserSnapshotProcessor(EntitySnapshotRegistry registry) {
    super(registry);
  }
  ...
  public void process(Player player, float partialTicks, ExtrasWriter entityWriter) {
    this.registry().captureSnapshot(entityWriter, TerraAddonKeys.TERRA_CHAT_USER, player);
  }
