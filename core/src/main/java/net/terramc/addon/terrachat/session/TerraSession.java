package net.terramc.addon.terrachat.session;
...
public class TerraSession implements Session {
  ...
  public TerraSession(String username, UUID uniqueId, String accessToken, Type type) {
